...
public class MentionListener: NSObject {
    ...
    public init(
        ...
        mentionTextAttributes = mentionAttributes ?? { _ in
            [Attribute(name: NSAttributedString.Key.foregroundColor.rawValue,
                       value: UIColor.blue)] }
